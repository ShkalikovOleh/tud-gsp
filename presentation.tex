...
\begin{frame}
    ...
    \textbf{The original purpose of scientific publishing} was to enable the global sharing of scientific results, ideas, and discussions within the academic society for more effective scientific achievements.\\~\
     ...
     influence of a publication is the most crucial criterion for many decisions
    ...
    the hiring of personnel academics
...
\begin{frame}
    ...
    \textbf{bibliographic databases are the main sources of publication metadata and citation metrics}\\~\

    Web of Science and Scopus are the two main bibliographic databases
...
\begin{frame}
    ...
    \begin{alertblock}{Note}
      Note that 2020 impact factors are reported in 2021; they cannot be calculated until all of 2020 publications have been processed by the indexing agency.
    \end{alertblock}
