...
\begin{frame}
    ...
    \begin{block}{What is CiteScore?}
        ...
        to published within prior 4 years for \textbf{all peer-reviewed documents} of a title.
    \end{block}
    ...
    \begin{itemize}
        ...
        \item $D(y)$ -- the number of all documents published in year $y$
    \end{itemize}
    ...
    \begin{columns}[T]
        \begin{column}{.5\textwidth}
            ...
            \begin{itemize}[<+->]
                ...
                \pros based on citations from peer-reviewed papers
            \end{itemize}
        \end{column}
        \begin{column}{.5\textwidth}
            \centering \textbf{Cons}
