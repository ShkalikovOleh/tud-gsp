...
\begin{frame}
    ...
    \begin{columns}[T]
        \begin{column}{.5\textwidth}
            ...
            \begin{propslist}
                \item They are the primary sources of publication metadata and citation metrics
                \pause
...
\begin{frame}
    ...
    It is calculated using data collected around research articles such as mentions
